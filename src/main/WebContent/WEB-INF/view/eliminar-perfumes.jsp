            ...
            <div class="row text-center py-3">
                <div class=" m-auto">
					<form action="del" method="get">
						...
						<strong class="h1 text-center">¿Desea eliminar el perfume?</strong>
						<br><br>
						<div class="contenedor-flexbox">
						<button class="button-dlt "  type="submit">Eliminar</button>
						<button class="button-cncl" type="button" onclick="window.location.href='/proyecto-web-perfumitos/perfumes/findAll; return false;'">Cancelar</button>
					</div>
					</form>
				</div>
	         </div>
