            ...
            <div class="row text-center py-3">
                <div class=" m-auto">	
					<form action="del" method="get">
						<input type="hidden" id="idCategoria" name="idCategoria" value="${categoriasModel.idCategoria}">
						<strong class="h1">¿Desea eliminar la Categoria?</strong>
						<br><br>
						<button class="button-dlt " type="submit">Eliminar</button>
						<button class="button-cncl" type="button" onclick="window.location.href='/proyecto-web-perfumitos/categorias/findAll; return false;'">Cancelar</button>
					</form>
				</div>
	         </div>
