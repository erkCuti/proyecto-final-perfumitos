...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Estamos Ubicados en Tumbaco</h1>
            <p>
               Direccion actual
            </p>
        </div>
        ...
        <div class="container ">
            <div class=" text-center "> 
                <div class=" m-auto">
				    ...
				    <div class="container"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6710.000111926302!2d-78.40883736925731!3d-0.21611760649943923!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91d5914bf2f2ed11%3A0xd241dc7aa4bca09!2sInstituto%20Tecnol%C3%B3gico%20Universitario%20ISMAC!5e0!3m2!1ses!2sec!4v1694743331566!5m2!1ses!2sec" width="80%" height="700px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="Nombres y Apellidos">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                ...
                <div class="mb-3">
                    <label for="inputsubject">Perfume a ofertar</label>
                    <input type="text" class="form-control mt-1" id="subject" name="subject" placeholder="Nombre del Perfume">
                </div>
                <div class="mb-3">
                    <label for="inputmessage">Mensaje</label>
                    <textarea class="form-control mt-1" id="message" name="message" placeholder="Descripción del perfume" rows="8"></textarea>
                </div>
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3">Hablanos</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li>
                            ...
                            <a class="text-decoration-none" href="tel:010-020-0340">069-069-6640</a>
                        </li>
                        <li>
